...
-- CreateEnum
CREATE TYPE "SaleType" AS ENUM ('ADET', 'PAKET', 'KOLI');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('SIPARIS_ALINDI', 'ODEME_BEKLENIYOR', 'ODEME_BILDIRILDI', 'ODEME_ONAYLANDI', 'HAZIRLANIYOR', 'KARGOYA_VERILDI', 'TESLIM_EDILDI', 'IPTAL_EDILDI');
...
CREATE TABLE "Product" (
    ...
    "priceAdet" DOUBLE PRECISION NOT NULL,
    "pricePaket" DOUBLE PRECISION NOT NULL,
    "paketQuantity" INTEGER NOT NULL DEFAULT 12,
    "priceKoli" DOUBLE PRECISION NOT NULL,
    "koliQuantity" INTEGER NOT NULL DEFAULT 250,
...
-- CreateIndex
CREATE UNIQUE INDEX "CartItem_userId_productId_saleType_key" ON "CartItem"("userId", "productId", "saleType");
